...
<a href="<%=request.getContextPath() %>/userDetail.jsp">ADD</a>
<br>
<table border="1" cellpadding="0" cellspacing="1" bordercolor="green" width="80%">
	<tbody>
		<tr >
		   <td width="5%" bgcolor="#00EEFF">No</td> 
		   <td width="5%" bgcolor="#00EEFF">User Id</td>
			...
			<td width="5%" bgcolor="#00EEFF">Command</td>
		</tr>
